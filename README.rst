...
**pyAS4** — це зручна обгортка навколо Zeep та MTOM/XOP-транспорту, яка спрощує створення й керування
...
Розробка ведеться у `репозиторії pyAS4 на GitHub <https://github.com/AndreyShapovalovVN/pyAS4>`_.
